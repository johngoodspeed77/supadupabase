...
**UI:** **Dark mode only** — **Cyan Hexagons** theme (tessellated flat-top honeycomb background) for admin and first-party pages. See [docs/THEME.md](./docs/THEME.md).
...
- **Theme** — admin and first-party UI use Cyan Hexagons tokens + tessellated honeycomb tile from THEME.md
