...
Dark mode only. Cyan accents (`#22d3ee`) on charcoal backgrounds with a **tessellated hexagon grid** (seamless flat-top honeycomb tile). Details: [docs/THEME.md](./docs/THEME.md).
